...
public final class Login7 implements TokenStream, ClientMessage {
	...
	public static class Builder {
		...
		@Nullable private CharSequence username;

		@Nullable private CharSequence password;

		@Nullable private CharSequence appName;

		@Nullable private CharSequence hostname;

		private CharSequence clientLibraryName;

		@Nullable private CharSequence databaseName;

		@Nullable private CharSequence serverName;
