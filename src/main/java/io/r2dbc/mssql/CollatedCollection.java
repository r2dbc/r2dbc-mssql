...
/**
 * {@link Collection} of column names. Retains column name ordering for iteration and applies SQL Server-specific naming conventions for column naming. Collection name comparison is case-insensitive
 * by default. Using escaped column names enforces identical comparison. Use square brackets to escape a column name (e.g. {@code [my_column]}).
 *
 * @author Mark Paluch
 */
