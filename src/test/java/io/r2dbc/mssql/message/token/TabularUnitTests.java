...
final class TabularUnitTests {
	...
	void shouldDecodeLoginAck() {
		...
		String hex = "0401019900340100e31b0001066d0061" + "007300740065007200066d0061007300"
		...
		assertThat(header.getType()).isEqualTo(Type.TABULAR_RESULT);

		Tabular tabular = Tabular.decode(header, byteBuf);

		assertThat(tabular.getTokens()).hasSize(7);
