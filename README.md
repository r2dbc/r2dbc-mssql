...
| `serverName`                    | Logical SQL Server name used as TLS SNI hostname and in the TDS login. Useful when `host` is a tunnel or proxy endpoint. Defaults to `host`, also the default for `hostNameInCertificate`. _(Optional)_                                                                   
